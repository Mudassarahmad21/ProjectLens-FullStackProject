...
//               <div>
//                 <div className="font-medium">Question outside scope</div>
//                 <p className="text-sm">{result.message || result.reasoning}</p>
//               </div>
//             </div>
//           </div>
//         )}
...
//               <AlertTriangle className="h-5 w-5 flex-shrink-0 mt-0.5" />
//               <div>
//                 <div className="font-medium">No Evidence Found</div>
...
//                 <div className="font-medium text-green-700">Answer</div>
